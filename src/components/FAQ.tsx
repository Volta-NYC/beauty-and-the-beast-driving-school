...
import { ChevronDown, CheckCircle, Shield, Users, Car, Clock, FileText, Award, Star, Phone, ArrowRight } from "lucide-react"
...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes! Our notary public is available during all business hours including Saturdays (9 AM - 3 PM). Walk-ins are welcome, but appointments are recommended for loan signings or complex documents. We also offer mobile notary service for an additional fee.",
  },
  {
